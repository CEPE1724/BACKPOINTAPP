...
CREATE TABLE EQFX_UAT_detalle_deuda_actual_sb (
    ...
    tipo_riesgo NVARCHAR(100) DEFAULT '' ,
    tipo_credito NVARCHAR(100) DEFAULT '' ,
...
const EQFX_UAT_detalle_deuda_actual_sb = new EntitySchema({
    name: 'EQFX_UAT_detalle_deuda_actual_sb',
    tableName: 'EQFX_UAT_detalle_deuda_actual_sb',
    target: class EQFX_UAT_detalle_deuda_actual_sb {
        constructor() {
            this.idEQFX_UAT_detalle_deuda_actual_sb = undefined;
    ...
    columns: {
        idEQFX_UAT_detalle_deuda_actual_sb: {
            type: 'int',
            primary: true,
            generated: true
        },
...
module.exports = EQFX_UAT_detalle_deuda_actual_sb;