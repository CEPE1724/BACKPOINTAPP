...
const EQFX_UAT_detalle_deuda_actual_seps = new EntitySchema({
    name: 'EQFX_UAT_detalle_deuda_actual_seps',
    tableName: 'EQFX_UAT_detalle_deuda_actual_seps',
    target: class EQFX_UAT_detalle_deuda_actual_seps {
        constructor() {
            this.idEQFX_UAT_detalle_deuda_actual_seps = undefined;
    ...
    ,
    columns: {
        idEQFX_UAT_detalle_deuda_actual_seps: {
            type: 'int',
            primary: true,
            generated: true
        },
...
module.exports = EQFX_UAT_detalle_deuda_actual_seps;
