/*
CREATE TABLE EQFX_UAT_detalle_deuda_historica_sb (
    idEQFX_UAT_detalle_deuda_historica_sb INT IDENTITY(1,1) PRIMARY KEY,
...
const EQFX_UAT_detalle_deuda_historica_sb = new EntitySchema({
    name: 'EQFX_UAT_detalle_deuda_historica_sb',
    tableName: 'EQFX_UAT_detalle_deuda_historica_sb',
    target: class EQFX_UAT_detalle_deuda_historica_sb {
        constructor() {
            this.idEQFX_UAT_detalle_deuda_historica_sb = undefined;
    ...
    columns: {
        idEQFX_UAT_detalle_deuda_historica_sb: {
            type: 'int',
            primary: true,
            generated: true
        },
...
module.exports = EQFX_UAT_detalle_deuda_historica_sb;
