/*
CREATE TABLE EQFX_UAT_detalle_deuda_historica_seps (
    idEQFX_UAT_detalle_deuda_historica_seps INT IDENTITY(1,1) PRIMARY KEY,
...
const EQFX_UAT_detalle_deuda_historica_seps = new EntitySchema({
    name: 'EQFX_UAT_detalle_deuda_historica_seps',
    tableName: 'EQFX_UAT_detalle_deuda_historica_seps',
    target: class EQFX_UAT_detalle_deuda_historica_seps {
        constructor() {
            this.idEQFX_UAT_detalle_deuda_historica_seps = undefined;
    ...
    columns: {
        idEQFX_UAT_detalle_deuda_historica_seps: {
            type: 'int',
            primary: true,
            generated: true
        },
...
module.exports = EQFX_UAT_detalle_deuda_historica_seps;