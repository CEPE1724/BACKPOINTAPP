/*CREATE TABLE EQFX_UAT_detalle_deuda_historica_sicom (
    idEQFX_UAT_detalle_deuda_historica_sicom INT IDENTITY(1,1) PRIMARY KEY,
...
const EQFX_UAT_detalle_deuda_historica_sicom = new EntitySchema({
    name: 'EQFX_UAT_detalle_deuda_historica_sicom',
    tableName: 'EQFX_UAT_detalle_deuda_historica_sicom',
    target: class EQFX_UAT_detalle_deuda_historica_sicom {
        constructor() {
            this.idEQFX_UAT_detalle_deuda_historica_sicom = undefined;
    ...
    columns: {
        idEQFX_UAT_detalle_deuda_historica_sicom: {
            type: 'int',
            primary: true,
            generated: true
        },
...
module.exports = EQFX_UAT_detalle_deuda_historica_sicom;