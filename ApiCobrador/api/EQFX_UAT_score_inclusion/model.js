...
const EQFX_UAT_score_inclusion = new EntitySchema({
    name: 'EQFX_UAT_score_inclusion',
    tableName: 'EQFX_UAT_score_inclusion',
    target: class EQFX_UAT_score_inclusion {
        constructor() {
            this.idEQFX_UAT_score_inclusion = undefined;
...
module.exports = EQFX_UAT_score_inclusion;