/*deuda_historica": [
{
"fecha_corte": "2017-05-31 00:00:00.000",
"por_vencer": 14011.98,
"no_devenga_int": 0,
"vencido_0_a_1": 0,
"vencido_1_a_2": 0,
...
"demanda_judicial": 0,
"cartera_castigada": 0,
"saldo_deuda": 14011.98,
"opcion": "SB"*/


/** * DTO for deuda_historica
 * @typedef {Object} DeudaHistoricaDTO
 ...
 * @property {string} opcion - Opción o tipo de deuda
 * //
 * /
 * 
 */
...
function parseDeudaHistorica(deuda_historica = []) {
    if (!Array.isArray(deuda_historica) || deuda_historica.length === 0) {
        return [];
    }

    return deuda_historica.map(item => ({
        fecha_corte: parseDateOrNull(item.fecha_corte),
        por_vencer: typeof item.por_vencer === 'number' ? item.por_vencer : 0.00,
        ...
        saldo_deuda: typeof item.saldo_deuda === 'number' ? item.saldo_deuda : 0.00,
        opcion: typeof item.opcion === 'string' ? item.opcion : '' 
    }));
}
module.exports = { parseDeudaHistorica };
